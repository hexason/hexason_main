...
export const AddressFormEdit = ({ data }: { data?: UserAddress }) => {
  ...
  const submitHandle = async (
    values: UserAddress,
    actions: FormikHelpers<UserAddress>
  ) => {
    await createAddress({
      variables: {
        data: {
        ...
        <Form>
          ...
          <Field name="address_city" validate={validateName}>
            {({ field, form }: any) => (
              <FormControl
                isInvalid={
                  form.errors.address_city && form.touched.address_city
                }
              >
          ...
          <Field name="address_district" validate={validateName}>
            {({ field, form }: any) => (
              <FormControl
                isInvalid={
                  form.errors.address_district && form.touched.address_district
                }
              >
          ...
          <Field name="address_street" validate={validateName}>
            {({ field, form }: any) => (
              <FormControl
                isInvalid={
                  form.errors.address_street && form.touched.address_street
                }
              >
          ...
          <Field name="address_info" validate={validateName}>
            {({ field, form }: any) => (
              <FormControl
                isInvalid={
                  form.errors.address_info && form.touched.address_info
                }
              >
          ...
          <Field name="contact_phone" validate={validateName}>
            {({ field, form }: any) => (
              <FormControl
                isInvalid={
                  form.errors.contact_phone && form.touched.contact_phone
                }
              >
          ...
          <Field name="contact_email" validate={validateName}>
            {({ field, form }: any) => (
              <FormControl
                isInvalid={
                  form.errors.contact_email && form.touched.contact_email
                }
              >
