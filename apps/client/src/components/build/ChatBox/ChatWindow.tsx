...
export default function ChatWindow({ messagesList }: any) {
  ...
  useEffect(() => {
    if (messageListEndRef.current)
      (messageListEndRef.current as any).scrollIntoView({ behavior: "smooth" });
  }, [messagesList]);
    ...
    >
        ...
        <Avatar
          src={
            oneMessage.role !== "user"
              ? "https://cdn.discordapp.com/attachments/960216281993322606/1098000261672349696/hexy.webp"
              : "https://cdn.discordapp.com/attachments/960216281993322606/1098000590820343858/image.png"
          }
        />
      </Box>
      ...
      <Stack alignItems={"center"} cursor={"pointer"} onClick={translateIt}>
        {loading ? (
          ...
          <GTransIcon height={20} width={20} fill="gray" />
        )}
      </Stack>
    </Stack>
  );
