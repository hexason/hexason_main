...
const dummy = [
  {
    provider: "taobao",
    providerIcon: "https://gw.alicdn.com/imgextra/i1/O1CN01LfyvED1TpRW5ppmks_!!6000000002431-2-tps-214-134.png"
  },
  {
    provider: "imex",
    ...
    <Stack>
      {
        dummy.map(supplier => (
          <Stack key={supplier.provider}>
            <HStack>
              <Image alt={supplier.provider} unoptimized width={100} height={25} src={supplier.providerIcon} />
